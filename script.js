...
//    if (!results.find(result => result.id === LearnerSubmissions[i].learner_id)) {
//        result.id = LearnerSubmissions[i].learner_id; // Assign learner_id to resultObj
//        results.push(resultObj); // Push resultObj into results
//    }
//}
//console.log(results);
